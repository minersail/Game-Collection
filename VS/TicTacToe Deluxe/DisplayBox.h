...
public:
	DisplayBox();
	DisplayBox(sf::Vector2i loc, float width, float height, std::string filename);
	DisplayBox(sf::Vector2i loc, float width, float height, std::string filename, std::string message);
	~DisplayBox();
